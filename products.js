...
const PRODUCTS = [
  { id:"Blue-Striped", name:"The Blue-Striped", price:4200, badge:{label:"New", type:"new"},
    category:"plain", rating:5, reviewCount:24,
    sizes:{ "14":0, "14.5":0, "15":1, "15.5":0, "16":0, "16.5":1, "17":0 },
    specs:{ fabric:"Irish Cotton", fit:"Regular Fit", pattern:"Stripe", collar:"Spread Collar", cuff:"Button Cuff", care:"Machine wash cold, hang dry, warm iron", origin:"Made in Pakistan" } },
  ...
  { id:"slate-french-cuff", name:"The Slate French Cuff", price:5100, badge:null,
    category:"check", rating:4, reviewCount:11,
  ...
  { id:"signature-white", name:"The Signature White", price:4200, badge:{label:"New", type:"new"},
    category:"stripe", rating:5, reviewCount:31,
